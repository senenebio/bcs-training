...
public class TerminalPassServiceImpl implements TerminalPassService {
    ...
    public List<TerminalPass> findVehiclesInsideTerminal() {
        ...
        List<TerminalPass> inside = new ArrayList<>();
        inside.addAll(terminalPassRepository.findByStatus("ARRIVED"));
    ...
    @Override
    public TerminalPass findByReceiptNumber(String receiptno) {
        return terminalPassRepository.findByReceiptNumber(receiptno);
    }
