...
public class Templates {
    ...
    static {
        ...
        HyperLinkBuilder link = hyperLink("http://www.naga.gov.ph");
        dynamicReportsComponent
                = cmp.horizontalList(
                        //can't get logo this to work - whick resource path to get pic from
                        //cmp.image(Templates.class.getResource("/images/logo.png")).setFixedDimension(60, 60),
                        cmp.verticalList(
                                cmp.text("Bicol Central Station").setStyle(bold22CenteredStyle).setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
                                cmp.text("http://www.naga.gov.ph").setStyle(italicStyle).setHyperLink(link))).setFixedWidth(300);
